...
func (uc *UserCreate) SetRole(h horizon.Role) *UserCreate {
	uc.mutation.SetRole(h)
	return uc
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (uc *UserCreate) SetNillableRole(h *horizon.Role) *UserCreate {
	if h != nil {
		uc.SetRole(*h)
	}
	return uc
...
func (uc *UserCreate) AddSongIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddSongIDs(ids...)
	return uc
}

// AddSongs adds the "songs" edges to the Song entity.
func (uc *UserCreate) AddSongs(s ...*Song) *UserCreate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uc.AddSongIDs(ids...)
}

// AddPlaylistIDs adds the "playlists" edge to the Playlist entity by IDs.
func (uc *UserCreate) AddPlaylistIDs(ids ...uuid.UUID) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.SongsIDs(); len(nodes) > 0 {
