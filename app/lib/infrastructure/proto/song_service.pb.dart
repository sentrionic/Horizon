...
enum CreateSongRequest_Data { details, chunkData, notSet }

class CreateSongRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, CreateSongRequest_Data>
      _CreateSongRequest_DataByTag = {
  ...
  factory CreateSongRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateSongRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CreateSongRequest copyWith(void Function(CreateSongRequest) updates) =>
      super.copyWith((message) => updates(message as CreateSongRequest))
          as CreateSongRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateSongRequest create() => CreateSongRequest._();
  CreateSongRequest createEmptyInstance() => create();
  static $pb.PbList<CreateSongRequest> createRepeated() =>
      $pb.PbList<CreateSongRequest>();
  @$core.pragma('dart2js:noInline')
  static CreateSongRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateSongRequest>(create);
  static CreateSongRequest? _defaultInstance;

  CreateSongRequest_Data whichData() =>
      _CreateSongRequest_DataByTag[$_whichOneof(0)]!;
  void clearData() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  SongDetails get details => $_getN(0);
  @$pb.TagNumber(1)
  set details(SongDetails v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set chunkData($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class SongDetails extends $pb.GeneratedMessage {
  ...
  factory SongDetails.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SongDetails.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SongDetails copyWith(void Function(SongDetails) updates) =>
      super.copyWith((message) => updates(message as SongDetails))
          as SongDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SongDetails getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SongDetails>(create);
...
class UpdateSongRequest extends $pb.GeneratedMessage {
  ...
  factory UpdateSongRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdateSongRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  UpdateSongRequest copyWith(void Function(UpdateSongRequest) updates) =>
      super.copyWith((message) => updates(message as UpdateSongRequest))
          as UpdateSongRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateSongRequest create() => UpdateSongRequest._();
  UpdateSongRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateSongRequest> createRepeated() =>
      $pb.PbList<UpdateSongRequest>();
  @$core.pragma('dart2js:noInline')
...
class SongRequest extends $pb.GeneratedMessage {
  ...
  factory SongRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SongRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SongRequest copyWith(void Function(SongRequest) updates) =>
      super.copyWith((message) => updates(message as SongRequest))
          as SongRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SongRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SongRequest>(create);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$1.SongResponse>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'songs',
        $pb.PbFieldType.PM,
        subBuilder: $1.SongResponse.create)
    ..hasRequiredFields = false;
