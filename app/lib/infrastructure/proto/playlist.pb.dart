...
class PlaylistResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PlaylistResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'songCount', $pb.PbFieldType.OU3)
  ...
  'Will be removed in next major version')
  PlaylistResponse copyWith(void Function(PlaylistResponse) updates) => super.copyWith((message) => updates(message as PlaylistResponse)) as PlaylistResponse; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set songCount($core.int v) { $_setUnsignedInt32(5, v); }
  @$pb.TagNumber(6)
