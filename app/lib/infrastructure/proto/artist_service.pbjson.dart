...
final $typed_data.Uint8List artistRequestDescriptor = $convert.base64Decode('Cg1BcnRpc3RSZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZA==');
...
const SearchArtistRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'order', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'order', '17': true},
  ],
  '8': const [
    const {'1': '_order'},
  ],
...
final $typed_data.Uint8List searchArtistRequestDescriptor = $convert.base64Decode('ChNTZWFyY2hBcnRpc3RSZXF1ZXN0EhIKBHBhZ2UYASABKA1SBHBhZ2USFAoFbGltaXQYAiABKA1SBWxpbWl0EhQKBXF1ZXJ5GAMgASgJUgVxdWVyeRIZCgVvcmRlchgEIAEoCUgAUgVvcmRlcogBAUIICgZfb3JkZXI=');
@$core.Deprecated('Use artistListResponseDescriptor instead')
const ArtistListResponse$json = const {
  '1': 'ArtistListResponse',
  '2': const [
    const {'1': 'artists', '3': 1, '4': 3, '5': 11, '6': '.pb.ArtistResponse', '10': 'artists'},
  ],
};

/// Descriptor for `ArtistListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List artistListResponseDescriptor = $convert.base64Decode('ChJBcnRpc3RMaXN0UmVzcG9uc2USLAoHYXJ0aXN0cxgBIAMoCzISLnBiLkFydGlzdFJlc3BvbnNlUgdhcnRpc3Rz');
